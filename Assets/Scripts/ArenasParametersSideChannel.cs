...
public class ArenasParametersSideChannel : SideChannel
{
    ...
    protected override void OnMessageReceived(IncomingMessage msg)
    {
		...
		UpdateTrainingAgentsWithYamlFileName(fileName);
    }
    ...
    private void UpdateTrainingAgentsWithYamlFileName(string fileName)
    {
        TrainingAgent[] agents = GameObject.FindObjectsOfType<TrainingAgent>();
        foreach (var agent in agents)
        {
            agent.SetYamlFileName(fileName);
        }
    }
