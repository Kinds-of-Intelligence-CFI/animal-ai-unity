...
/// <summary>
/// Manages the flashing of an image. The image will flash on and off at a specified speed.
/// </summary>
public class FlashingImage : MonoBehaviour
{
    ...
    private void SetImageAlpha(float alpha)
    {
        ...
        {
            imageToFlash.color = new Color(
                imageToFlash.color.r,
                imageToFlash.color.g,
                imageToFlash.color.b,
                alpha
            );
        }
    }
